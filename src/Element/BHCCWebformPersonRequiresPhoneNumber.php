...
class BHCCWebformPersonRequiresPhoneNumber extends WebformCompositeBase {
  ...
  public static function getCompositeElements(array $element) {
    ...
    $elements['uk_mobile_phone'] = [
      ...
      '#after_build' => [
        ...
        // [get_called_class(), 'afterBuildPhoneRequired'],
      ],
      '#attributes' => [
  ...
  /**
   * Alter the 'Date elements' after it has been built.
   */
  ...
  /**
   * Function to alter the 'UK phone numbers' element after it has been built.
   */
  ...
  /**
   * Alter the internaltionalphone number after they have been built.
   */
  ...
  /**
   * Alter the phone required after the element has been built.
   */
  public static function afterBuildPhoneRequired(array $element, FormStateInterface $form_state) {
  ...
  /**
   * Function to alter Details element after its been built.
   */
