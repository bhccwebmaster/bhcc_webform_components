 ...
 *
 * @WebformElement(
 *   id = "bhcc_webform_person_requires_contact_method",
 *   label = @Translation("BHCC Webform Person Composite - Requires at least one Contact method"),
 *   description = @Translation("Provides a BHCC composite person type and enforces a minimum of one contact method"),
