 ...
 *
 * @WebformElement(
 *   id = "bhcc_webform_person_no_name",
 *   label = @Translation("BHCC Webform Person Composite - may not have a name"),
 *   description = @Translation("Provides a BHCC composite person type who may not have a name"),
 ...
 */
class BHCCWebformPersonNoName extends WebformCompositeBase {
